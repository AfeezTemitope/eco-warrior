    ...
    return (
        <div className="space-y-6">
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6">
                <h2 className="text-lg sm:text-xl font-semibold mb-4 sm:mb-6 text-gray-900">Create New Admin</h2>
                                ...
                                admins.map((admin) => (
                                    <tr key={admin.id} className="hover:bg-gray-50 transition-colors">
                                        <td className="px-4 sm:px-6 py-4">
                                            <div className="font-medium text-gray-900 truncate max-w-[120px] sm:max-w-none">{admin.username}</div>
                                        </td>
                                        <td className="px-4 sm:px-6 py-4 hidden sm:table-cell">
                                            <div className="text-sm text-gray-600 truncate max-w-[200px]">{admin.id}</div>
                                        </td>
                                        <td className="px-4 sm:px-6 py-4">
                                                <span
                                        ...
                                        <td className="px-4 sm:px-6 py-4 text-right">
                                            <button
                                                ...
                                                aria-label={`Remove admin ${admin.username}`}
