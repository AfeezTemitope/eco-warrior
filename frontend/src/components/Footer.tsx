    ...
    return (
        <footer className="bg-gradient-to-br from-[#2E7D32] via-green-600 to-emerald-600 text-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                    ...
                    <div>
                        <Link to="/" className="flex items-center gap-2 mb-4 group">
                            <img
                                src="/logo.png"
                                alt="EcoWarrior Africa Logo"
                                className="w-12 h-12 object-contain"
                            />
                            <span className="text-xl font-bold group-hover:text-gray-100 transition-colors">
                                EcoWarrior Africa
                            </span>
                        </Link>
                        <p className="text-gray-100 text-sm leading-relaxed mb-4">
                            Championing environmental education and advocacy for sustainable development across Africa.
                        </p>
                        <div className="flex gap-4">
                            ...
                            <a
                                ...
                                aria-label="Email EcoWarrior Africa"
                                className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-white/20 transition-colors"
                            >
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                aria-label="Follow EcoWarrior Africa on Instagram"
                                className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-white/20 transition-colors"
                            >
                ...
                {/* Bottom Bar */}
                <div className="border-t border-white/20 pt-8 flex flex-col md:flex-row justify-between items-center text-sm gap-4">
                    <p className="text-gray-100 text-center md:text-left">
                        © {currentYear} EcoWarrior Africa. All rights reserved.
                    </p>
                    <div className="flex items-center gap-2 text-gray-100 flex-wrap justify-center">
                        <span>Built with</span>
                        <FaHeart className="text-red-400 animate-pulse" aria-hidden="true" />
                        <span>by</span>
                        <a
                            href="https://afeeztemitope.com"
                            target="_blank"
                            rel="noopener noreferrer"
